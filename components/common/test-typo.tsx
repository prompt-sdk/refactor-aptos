...
const TestTypo = () => {
  ...
  return (
    <div className="prose mx-auto my-4 max-w-4xl">
      <h1>Typography</h1>
      <p className="lead">
      ...
      <p>
        ...
        your dashboard UI. And I doubt you really want your blog posts to use the user-agent styles either — you want
        them to look
      ...
      <p>
        It adds a new <code>prose</code> className that you can slap on any block of vanilla HTML content and turn it
        into a beautiful, well-formatted document:
      </p>
      <pre>
        <code className="language-html">
          &lt;article class=&quot;&quot;&gt; &lt;h1&gt;Garlic bread with cheese: What the science tells us&lt;/h1&gt;
      ...
      <ol>
        <li>
          ...
          <ul>
            <li>
              You might feel like you are being really or something but you are just creating a gross shape on the
      ...
      <p>
        ...
        two heading levels for a reason, you animals. I honestly considered using a <code>before</code> pseudo-element
      ...
      <p>
        ...
        are the same size as the body copy. What are we supposed to do with an <code>h5</code>, make it <em>smaller</em>
